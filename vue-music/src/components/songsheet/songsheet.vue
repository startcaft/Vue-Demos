    ...
    <transition name="sliderUpHideRight">
        <div class="songsheet" ref="songsheet" v-show="showSongSheet" @scroll="scrollEvent">
            <div class="songheader">
                <i class="back iconfont icon-fanhuitubiao" @click.stop="hideSongSheet"></i>
				<p class="title">歌单</p>
				<i class="search iconfont icon-search1"></i>
				<i class="menu iconfont icon-more2"></i>
            ...
            <div class="content">
                <div class="top" ref="top">
                    ...
                    <div class="do">
                        ...
                        <div class="list">
                            <i class="iconfont icon-hyfenxiang"></i>
                ...
                <div class="bottom">
					<div class="bottom-wrapper">
						...
						<div class="rightSetting">
							<i class="iconfont icon-icon_list_line"></i>
							<span>多选</span>
						</div>
					</div>
            ...
            <!--下载封面页面 自定义事件 hidedownloadimage-->
...
<script>
    import bottomBar from '../bottombar/bottom-bar.vue'
    ...
    export default {
        ...
        methods: {
            ...
            showDownloadImg(){
				...
				this.$refs.songsheet.style.overflow = 'hidden';//修剪 songsheet 歌单区域
            },
            hideDownloadImg() {
        ...
        computed: {
            showSongSheet(){    //显示状态
                this.isShow = this.$store.getters['audioInfo/getIsShowSongSheet']
                                ? this.$store.getters['audioInfo/getIsShowSongSheet']
                                : false;
                return this.isShow;
            },
            getSongSheet(){
                this.sheetData = this.$store.getters['audioInfo/getMusicSheetList'];
        ...
        watch: {
            isShow : function(newisshwo, oldisshow){
                ...
                let img = this.$store.getters['audioInfo/getMusicSheetList'] 
                            ? this.$store.getters['audioInfo/getMusicSheetList']  
                            : '';
                //console.log(img);
                if(newisshwo){
