<template>
    <section class="reply">
        <textarea id="content" rows="5" class="text" v-model="content" 
            placeholder="回复支持Markdonw语法，请注意标记代码"></textarea>
    ...
    export default {
        ...
        methods:{
            handleReply(){
                ...
                v.$http.post('https://cnodejs.org/api/v1/topic/' + v.topicId +'/replies',data)
